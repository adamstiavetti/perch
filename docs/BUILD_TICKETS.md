...
- [Public Waitlist Launch Readiness Check](ops/public-waitlist-launch-readiness-check.md) - W05 audit for root-domain launch readiness, W05A metadata/legal/accessibility blocker resolution, rollback steps, and the final cutover checklist for moving the public waitlist to `jmpseat.com` while keeping `beta.jmpseat.com` private.
