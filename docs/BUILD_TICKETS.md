...
- [Waitlist Metrics Dashboard](ops/waitlist-metrics-dashboard.md) - implementation note for the operator/admin-only `/app/admin/waitlist` dashboard, safe aggregate waitlist metrics, masked recent submissions, and pending runtime validation.
