...
- [First-Base MVP Implementation Ticket Pack](epochs/first-base-mvp-implementation-ticket-pack.md) - translates the pivot strategy docs into the ordered `FBMVP` implementation sequence and recommends continuing with `FBMVP-T04` after the FBMVP-T03 launch-mode access gate is reviewed.
